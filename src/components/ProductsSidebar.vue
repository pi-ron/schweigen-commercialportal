<template>
  <div class="filter-heading s-m-b-0">
  ...
  <div class="filter-heading s-m-b-16">
    <span v-if="showingAllRecords" class="body-text s">
      Showing all products ({{allRecordsCount}})
    </span>
    <span v-if="!showingAllRecords" class="body-text s">
      Showing {{filteredRecordsCount}} of {{allRecordsCount}} products
    </span>
  </div>
