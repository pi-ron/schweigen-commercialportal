<template>
      ...
      @click="updateSort(direction)"
      v-if="direction == 'asc' && active == false">
      </chevron-up-circle-outline>
      <chevron-down-circle-outline
      @click="updateSort(direction)"
      v-if="direction == 'dsc' && active == false">
      </chevron-down-circle-outline>
      <chevron-up-circle
      @click="updateSort(direction)"
      v-if="direction == 'asc' && active == true"
      class="icon-active">
      </chevron-up-circle>
      <chevron-down-circle
      @click="updateSort(direction)"
      v-if="direction == 'dsc' && active == true"
      class="icon-active">
      </chevron-down-circle>
</template>
...
<script>
import {
  ChevronUpCircleOutline, ChevronDownCircleOutline, ChevronUpCircle, ChevronDownCircle,
} from 'mdue';
...
export default {
  ...
  computed: {
    ...
    active() {
      ...
      if (this.activeSort != null && this.activeSort.includes(this.direction)) {
        return true;
      }
      return false;
    },
